...
// 진단 7모듈 (M1~M7) — 확정 도구명·문항수·배치 단계·결정 항목
export const DIAGNOSIS_MODULES: DiagnosisModule[] = [
  {
    ...
    stageLabel: '1단계 · 유형진단',
    decides: '학생 6유형 분류',
    desc: '4개 영역을 통합 측정해 학생을 6가지 표준 유형으로 분류합니다.',
    time: '약 15분',
    questions: '39문항',
    category: '유형진단',
    art: 'aptitude',
  ...
  },
  {
    ...
    stageLabel: '1단계 · 자기이해',
    decides: '자기이해 수준 파악',
    desc: '흥미·가치·강점·성향을 파악해 진로 탐색의 기초 데이터를 만듭니다.',
    time: '약 15분',
    questions: '준비중',
    category: '진로·적성',
    art: 'psychology',
  ...
  },
  {
    ...
    stageLabel: '3단계 · 경력개발 로드맵',
    decides: 'IAP 유형 · 직무역량 모듈 결정',
    desc: '진로 목표의 구체성과 명확성을 진단해 IAP 유형과 로드맵의 기준을 만듭니다.',
    time: '약 30분',
    questions: '153문항',
    category: '진로·적성',
    art: 'cares',
    ...
    requires: ['M1'],
    recentAt: '2026. 05. 16 16:40',
  },
  {
    id: 'M4',
    testId: 'kvct',
    name: 'KVCT 직무역량검사 + E-DISC',
    area: '관계 · 사고 · 실행 · 신체 · 감각 · 정서안정 / 행동유형',
    stageLabel: '4단계 · 역량강화',
    decides: '직무군 매칭 · 기업연계 우선순위',
    desc: '전공·역량·성향 기반으로 직무 적합성과 직무군 매칭을 산출합니다.',
    time: '약 40분',
    questions: '329 + 24문항',
    category: '역량·직무',
    art: 'job',
  ...
  },
  {
    ...
    testId: 'neo',
    name: 'NEO 성격검사',
    area: '외향성 · 개방성 · 친화성 · 성실성 · 신경증',
    stageLabel: '6단계 · 사후관리',
    decides: '집중관리 대상 · 상담개입 강도',
    desc: '성격 특성을 진단해 집중관리 대상 선별과 상담개입 강도를 설정합니다.',
    time: '약 35분',
    questions: '211문항',
    category: '심리·성향',
    art: 'psychology',
