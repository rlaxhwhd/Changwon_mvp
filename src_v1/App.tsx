...
import RoadmapLanding from './pages/RoadmapLanding';
...
function getInitialPage(): PageId {
  if (typeof window !== 'undefined' && window.location.pathname === '/roadmapStart') {
    return 'ai-roadmap-landing';
  }
  return 'landing';
}
...
function App() {
  ...
  const renderPage = () => {
    switch (page) {
      ...
      case 'ai-roadmap-landing':
        return <RoadmapLanding onNavigate={navigate} onToast={showToast} />;
      case 'ai-roadmap':
  ...
  const isRoadmapLanding = page === 'ai-roadmap-landing';
  ...
  /* Roadmap landing — standalone full-viewport site, no sidebar */
  if (isRoadmapLanding) {
    return (
      <>
        {renderPage()}
